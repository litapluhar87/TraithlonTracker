            ...
            <div className="space-y-3">
			  {(() => {
			    ...
			    <div key={i} className="bg-[#090D18] border border-[#242E48] rounded-xl p-2 shadow-[0_8px_24px_rgba(0,0,0,0.18)]">
                  ...
                  >
                    {/* ROW 1 — Date | On track/Behind + extrapolated time | Edit */}
                    <div className="grid grid-cols-[minmax(0,1fr)_auto_auto] items-center gap-2">
                      ...
                      <button
                        ...
                        className="w-6 h-6 rounded-md flex items-center justify-center flex-shrink-0 text-[#5C6688] hover:text-[#22C3FF] hover:bg-[#22C3FF]/10 transition-colors"
                    ...
                    {/* ROWS 2 + 3 — Icon spans both rows */}
                    <div className="grid grid-cols-[2rem_minmax(0,1fr)_auto] grid-rows-2 items-center gap-x-2 gap-y-0.5 mt-0.5">

                      {/* Discipline icon — spans Row 2 and Row 3 */}
                      <div
                        className="row-span-2 w-8 h-full min-h-[42px] rounded-[9px] flex items-center justify-center"
                      ...
                      <p className="min-w-0 text-xs text-[#9BA6C4] truncate">
                      ...
                      {/* ROW 3 — Pace */}
                      <p
                        className="min-w-0 text-sm font-mono font-semibold"
                        style={{ color }}
                      >
                      ...
                      {/* Expand / Collapse — Row 3 */}
                      {s.ai_summary ? (
                        <ChevronDown
                          size={14}
                          className={`text-[#9BA6C4] transition-transform
